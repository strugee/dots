BASIC = .bash_aliases .bash_logout .bash_profile .bashrc .byobu .emacs .gitconfig .gitignore .gitmodules .profile .reportbugrc .screenrc .selected_editor .zsh-update .zsh_favlist .zshrc.pre-oh-my-zsh bin .pam_environment .netscape
